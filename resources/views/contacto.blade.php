...
<div class="bg-gradient-to-r from-green-700 to-lime-500 w-full h-19">
  ...
  @else
      ...
      <button class="pt-4 pr-2 pl-2 pb-4 text-lg text-white rounded-none hover:bg-gray-800 "><a href="/logout">Logout</a></button>
@endif
...
@if(Auth::User())
      ...
      <button class="pt-4 pr-2 pl-2 pb-4 text-lg text-white rounded-none hover:bg-gray-800 "><a href="/reservas">Reservar</a></button>
@endif
      <button class="pt-4 pr-2 pl-2 pb-4 text-lg text-white rounded-none hover:bg-gray-800 "><a href="/contacto">Contacto</a></button>
  ...
  <section class="mb-32 text-center text-gray-800">
    <div class="max-w-[700px] mx-auto px-3 lg:px-6">
      <h2 class="text-3xl font-bold mb-12">Contacte-nos </h2>
      <form>
        ...
        <div class="form-group mb-6">
          ...
          " id="exampleFormControlTextarea13" rows="3" placeholder="Mensagem"></textarea>
        </div>
